...
?>
    <tr>
      <th scope="row"><?php echo $detalhes->codfamilia; ?></th>
      <td><?php echo $detalhes->nomefamilia; ?></td>


      <td>
        <form action="{{ url('/home/inventory/list-families/edit-families') }}">
          <input type="hidden" name="codfamilia" value="<?= $detalhes->codfamilia;?>">
      ...
      <td>
      <form action="{{ url('remove-families') }}" >
        <input type="hidden" name="codfamilia" value="<?= $detalhes->codfamilia;?>">
