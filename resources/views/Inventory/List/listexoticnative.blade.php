...
?>
    <tr>
      ...
      <td>{{ $detalhes->nomenativaexotica }}</td>


      <td>
        <form action="{{ url('/home/inventory/list-exoticnative/edit-exoticnative')}}">
          <input type="hidden" name="codnativaexotica" value="{{ $detalhes->codnativaexotica }}" method="GET">
      ...
      <td>
      <form action="{{ url('remove-exoticnative')}}" >
        <input type="hidden" name="codnativaexotica" value="{{ $detalhes->codnativaexotica }}" method="GET">
