...
<table class="table table-striped">
  ...
  require 'vendor/autoload.php';
   ...
   //implementar pra chamar a rota do login do spring boot
...
?>
    <tr>
      <th scope="row"><?php echo $detalhes->codautor; ?></th>
      <td><?php echo $detalhes->nomeautor; ?></td>


      <td>
        <form action="editar-autor-formulario.php">
