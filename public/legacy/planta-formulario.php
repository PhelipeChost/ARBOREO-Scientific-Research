...
<div class="container">
    ...
    <a href="lista-plantas.php" class="btn btn-success">Ver Lista de Plantas</a>
</div>
...
<form action="salvar-planta.php" method="POST">
    <table class="table">
        <tr>
        ...
        <tr>
            ...
            <td><input class="form-control" type="number" placeholder="Coordenada S" name="coordenada_s" id="coordenada_s" maxlength="15" step="any" data-ls-module="charCounter"/>
            </td>

            <td>
                Coordenada O:
            </td>
            <td><input class="form-control" type="number" placeholder="Coordenada O" name="coordenada_o" maxlength="3" step="any" data-ls-module="charCounter"/>
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td>
                <select name="select-familia" class="form-control" id="selectFamilia">
                    ...
                    <?php foreach ($data as $tabfamilias) : ?>
                        <option value="<?php echo $tabfamilias->nomefamilia; ?>"><?php echo $tabfamilias->nomefamilia; ?></option>
                    <?php endforeach ?>
                </select>
                <script>
                    ...
                    <div>
                        ...
                        <script>
                            document.getElementById('cadastrarBtnespecie').addEventListener('click', function abreform(event) {
                                ...
                                var xhr = new XMLHttpRequest();
                                xhr.open('POST', 'salvar-especie.php');
                                xhr.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded');
                    ...
                    <div>
                        ...
                        <script>
                            document.getElementById('cadastrarBtnlocal').addEventListener('click', function abreform(event) {
                                ...
                                var xhr = new XMLHttpRequest();
                                xhr.open('POST', 'salvar-local.php');
                                xhr.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded');
...
<?php include("imagem-formulario.php"); ?>
