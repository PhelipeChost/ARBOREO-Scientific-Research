...
?>
    <tr>
      <th scope="row"><?php echo $detalhes->codnativaexotica; ?></th>
      <td><?php echo $detalhes->nomenativaexotica; ?></td>


      <td>
        <form action="editar-nativaexotica-formulario.php">
      ...
      <td>
      <form action="remover-nativaexotica.php" >
        <input type="hidden" name="codnativaexotica" value="<?= $detalhes->codnativaexotica;?>">
