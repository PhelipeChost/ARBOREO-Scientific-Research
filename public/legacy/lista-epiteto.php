...
?>
    <tr>
      <th scope="row"><?php echo $detalhes->codepiteto; ?></th>
      <td><?php echo $detalhes->nomeepiteto; ?></td>


      <td>
        <form action="editar-epiteto-formulario.php">
      ...
      <td>
      <form action="remover-epiteto.php" >
        <input type="hidden" name="codepiteto" value="<?= $detalhes->codepiteto;?>">
